...
[Defines]
  ...
  PLATFORM_GUID                  = 0458dade-8b6e-4e45-b773-1b27cbea3e06
  PLATFORM_VERSION               = 0.01
  DSC_SPECIFICATION              = 0x00010006
  OUTPUT_DIRECTORY               = Build/OkrPkg
...
#  PathLib|ShellPkg/Library/BasePathLib/BasePathLib.inf
  ...
  #NtfsLib|OkrPkg/ntfswin/libntfs.inf
...
#### Sample Applications.
#  OkrPkg/ntfswin/libntfs.inf          # Simple invocation. No other LibC functions.
  OkrPkg/okrefi/okrefi.inf
  OkrPkg/ntfswin/ntfs.inf          # Simple invocation. No other LibC functions.
  OkrPkg/okr.inf
