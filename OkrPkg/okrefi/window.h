...
#define WM_MOUSE_MID_SCROLL_UP			0XFE41		//鼠标滚轮向上滚动
#define WM_MOUSE_MID_SCROLL_DOWN		0XFE42		//鼠标滚轮向下滚动

#define WM_MOUSEDRAG  0xfe43           //鼠标左键按下，并移动

#define  WM_BTN_SELCHANGE 0XFF10

#define WM_UPDATE_PART_LIST 0xfe81

#define WM_TIME_COUNT_DOWN 0xfe85
...
//	WORD msg_callback_num;
	...
	WORD windowID;	//窗体ID: 主页: 1, 关机/重启确认框: 100，备份位置:200,  恢复文件选择:300,  新硬盘恢复:400
} WINDOW , *PWINDOW;
...
//修改Window的退出标记，可以重新调用Window_run
...
#define ITEM_TYPE_DISKBTN    16 //此单元内嵌一个自定义内容

//colors
//#define LISTBOX_SELLINE_COLOR		COLOR_LIST_SELECTED	//0X3C82C8	
//#define LISTBOX_SELLINE_COLOR_INAC	0XC0C0C0	//disable??
//#define LISTBOX_LINE_COLOR			0xCCE0ED	//0x827864
...
typedef struct LISTBOX
{
	...
	struct ONEITEM itemlist[700];        //一行一个item,一个item用一个结构表示，目前最多50行，以后这个数组会动态分配。
	...
	void (* showitems)(struct LISTBOX* plistbox, int focus);
	DWORD backgroundColor;	//窗口背景色
	DWORD frameColor;	//窗口边线色
	DWORD selectItemBkColor;	//选择项背景色
	struct LISTBOX *pBindCtrlListbox;        //滚动条
...
#define  SCROLLBOX_RANGE_COLOR			0xEFF4F7	//0xEEEEEE
#define  SCROLLBOX_LINE_COLOR			COLOR_LIST_SPLIT_LINE	//0xCAC8C9
#define  SCROLLBOX_DRAGBOX_COLOR		COLOR_SCROLL_BAR_NORMAL	//0xCDCDCD
#define  SCROLLBOX_DRAGBOX_SEL_COLOR	COLOR_SCROLL_BAR_DRAG	//0x606060
#define  SCROLLBOX_DRAGBOX_OUT_COLOR	COLOR_SCROLL_BAR_DRAG	//0x606060
//bindctl: 需要和滚动条绑定的控件
...
//#define TITLEBOX_BG_COLOR			COLOR_LIST_BK //0XEBE8E1
//#define TITLEBOX_GREYLINE_COLOR		COLOR_LIST_SPLIT_LINE //0XBEB9B4
//#define TITLEBOX_FRAMELINE_COLOR	COLOR_LIST_SPLIT_LINE //0x827864
...
#define EDITBOX_BACKGROUND	0xFFFFFF //0XF5F3F4
//以下是编辑框模式，按位定义（可以组合）
...
struct DrvButtonList {
	...
	struct SCROLL_BOX* pscroll; //Scrollbox
