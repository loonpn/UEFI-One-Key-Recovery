...
/*  0*/	/*NTFS_RECORD_TYPES*/u32 magic;/* The magic is "RSTR". */
...
/* 12*/	le16 client_in_use_list;/* The index of the first in-use log client
				   ...
				   open, even on clean shutdown so this should
				   always be 0. */
/* 14*/	/*RESTART_AREA_FLAGS*/u16 flags;/* Flags modifying LFS behaviour.  On Win2k
...
typedef struct {
/*  0	NTFS_RECORD; -- Unfolded here as gcc doesn't like unnamed structs. */
	/*NTFS_RECORD_TYPES*/u32 magic;/* Usually the magic is "RCRD". */
