 ...
 */
typedef struct {
	/*NTFS_RECORD_TYPES*/u32 magic;/* A four-byte magic identifying the
...
/*  0	NTFS_RECORD; -- Unfolded here as gcc doesn't like unnamed structs. */
	u32 magic;/* Usually the magic is "FILE". */
...
/*Ofs*/
/*  0	NTFS_RECORD; -- Unfolded here as gcc doesn't like unnamed structs. */
	/*NTFS_RECORD_TYPES*/u32 magic;/* Usually the magic is "FILE". */
	u16 usa_ofs;		/* See NTFS_RECORD definition above. */
	u16 usa_count;		/* See NTFS_RECORD definition above. */
...
/*  0*/	ntfschar name[0x40];		/* Unicode name of the attribute. Zero
					   terminated. */
/* 80*/	/*ATTR_TYPES*/u32 type;		/* Type of the attribute. */
/* 84*/	u32 display_rule;		/* Default display rule.
					   FIXME: What does it mean? (AIA) */
/* 88*/ /*COLLATION_RULES*/u32 collation_rule;	/* Default collation rule. */
/* 8c*/	/*ATTR_DEF_FLAGS*/u32 flags;		/* Flags describing the attribute. */
...
typedef struct {
/*Ofs*/
/*  0*/	/*ATTR_TYPES*/u32 type;	/* The (32-bit) type of the attribute. */
...
/* 32*/	/*FILE_ATTR_FLAGS*/u32 file_attributes; /* Flags describing the file. */
/* 36*/	union {
...
typedef struct {
/*Ofs*/
/*  0*/	/*ATTR_TYPES*/u32 type;	/* Type of referenced attribute. */
...
/* 30*/	s64 data_size;			/* Byte size of actual data in data
					   attribute. */
/* 38*/	/*FILE_ATTR_FLAGS*/u32 file_attributes;	/* Flags describing the file. */
/* 3c*/	union {
	/* 3c*/	struct {
...
/**
 * struct GUID_NTFS - GUID_NTFS structures store globally unique identifiers (GUID_NTFS).
 *
 * A GUID_NTFS is a 128-bit value consisting of one group of eight hexadecimal
 * digits, followed by three groups of four hexadecimal digits each, followed
 * by one group of twelve hexadecimal digits. GUID_NTFSs are Microsoft's
 * implementation of the distributed computing environment (DCE) universally
 * unique identifier (UUID).
 *
 * Example of a GUID_NTFS:
 *	1F010768-5A73-BC91-0010-A52216A7227B
 */
typedef struct {
	u32 data1;	/* The first eight hexadecimal digits of the GUID_NTFS. */
...
} __attribute__((__packed__)) GUID_NTFS;
...
typedef struct {
	...
	union {
		struct {
			GUID_NTFS birth_volume_id;
			GUID_NTFS birth_object_id;
			GUID_NTFS domain_id;
		} __attribute__((__packed__));
		u8 extended_info[48];
	} __attribute__((__packed__));
 ...
 */
typedef struct {
	GUID_NTFS object_id;				/* Unique id assigned to the
						   file.*/
	/* The following fields are optional. The attribute value size is 16
	   bytes, i.e. sizeof(GUID_NTFS), if these are not present at all. Note,
	...
	union {
		struct {
			GUID_NTFS birth_volume_id;	/* Unique id of volume on which
						   the file was first created.*/
			GUID_NTFS birth_object_id;	/* Unique id of file when it was
						   first created. */
			GUID_NTFS domain_id;		/* Reserved, zero. */
		} __attribute__((__packed__));
		u8 extended_info[48];
	} __attribute__((__packed__));
 ...
 */
typedef struct {
	/*ACE_TYPES*/u8 type;		/* Type of the ACE. */
	/*ACE_FLAGS*/u8 flags;	/* Flags describing the ACE. */
 ...
 */
typedef struct {
	/*ACCESS_MASK*/u32 generic_read;
	/*ACCESS_MASK*/u32 generic_write;
	/*ACCESS_MASK*/u32 generic_execute;
	/*ACCESS_MASK*/u32 generic_all;
...
/*  4*/	/*ACCESS_MASK*/u32 mask;	/* Access mask associated with the ACE. */
...
/*  4*/	/*ACCESS_MASK*/u32 mask;	/* Access mask associated with the ACE. */
/*  8*/	/*OBJECT_ACE_FLAGS*/u32 object_flags;	/* Flags describing the object ACE. */
/* 12*/	GUID_NTFS object_type;
/* 28*/	GUID_NTFS inherited_object_type;
...
typedef struct {
	...
	u8 alignment;
	/*SECURITY_DESCRIPTOR_CONTROL*/u16 control; /* Flags qualifying the type of
...
typedef struct {
	...
	/*VOLUME_FLAGS*/u16 flags;	/* Bit array of VOLUME_* flags. */
 ...
 */
typedef struct {
/*  0*/	/*ATTR_TYPES*/u32 type;		/* Type of the indexed attribute. Is
					   $FILE_NAME for directories, zero
					   for view indexes. No other values
					   allowed. */
/*  4*/	/*COLLATION_RULES*/u32 collation_rule;	/* Collation rule used to sort the
...
typedef struct {
/*  0	NTFS_RECORD; -- Unfolded here as gcc doesn't like unnamed structs. */
	/*NTFS_RECORD_TYPES*/u32 magic;/* Magic is "INDX". */
...
typedef struct {
	...
	/*QUOTA_FLAGS*/u32 flags;	/* Flags describing this quota entry. */
...
/* 16*/	union {		/* The key of the indexed attribute. NOTE: Only present
		...
		GUID_NTFS object_id;		/* $O index in FILE_Extend/$ObjId: The
...
typedef struct {
	...
	/*EA_FLAGS*/u8 flags;		/* Flags describing the EA. */
 ...
 * SID, an optional GUID_NTFS, an optional container name, a non-optional user name,
...
/* 16*/	u8 unknown4[16];	/* MD5 hash of decrypted FEK?  This field is
				   ...
				   likely to be GUID_NTFS of this encrytped file
