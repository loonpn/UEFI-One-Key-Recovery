...
static BOOL ntfs_check_restart_page_header(RESTART_PAGE_HEADER *rp, s64 pos)
{
	...
	if (usa_ofs < sizeof(RESTART_PAGE_HEADER) ||
		...
		utils_dump_mem(rp,0,512,0);
		ntfs_log_error("$LogFile restart page specifies "
				"inconsistent update sequence array offset.usa_ofs=%u,usa_end=%u,sizeof(RESTART_PAGE_HEADER)=%u,NTFS_BLOCK_SIZE - sizeof(u16)=%u\n",usa_ofs,usa_end,sizeof(RESTART_PAGE_HEADER),NTFS_BLOCK_SIZE - sizeof(u16));
